...
while trial < day_count:
    ...
    for i in range(touch_sensor_start,touch_sensor_start+time_offset): #to get collection data change range to (water start, 50) (.025 is the water collection time+0.025 extra)
        if touch_sensor[i] > 1:
