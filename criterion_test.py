...
while trial < day_count:
    ...
    trial_range += 22000
    touch_sensor_start = water_start - 1000 
    for i in range(touch_sensor_start,touch_sensor_start+1000):
        if touch_sensor[i] > 1:
...
#general lick count over all trials on most recent day
cs_plus_licked_total_last = 0
cs_minus_licked_total_last = 0
cs_plus_none_total_last = 0
cs_minus_none_total_last = 0
